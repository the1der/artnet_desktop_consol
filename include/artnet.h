...
typedef struct __attribute__((packed)) STalkToMe
{
  uint8_t unused1 : 4;
  uint8_t Unicast : 1;
  uint8_t SendDiag : 1;
...
typedef struct __attribute__((packed)) SArtPoll
{
  uint8_t   ID[8];
  uint16_t  OpCode;
  uint8_t   ProtVerHi;
...
typedef struct __attribute__((packed)) SStatus1
{
...
typedef struct __attribute__((packed)) SPortType
{
...
typedef struct __attribute__((packed)) SGoodInput
{
...
typedef struct __attribute__((packed)) SGoodOutput
{
...
typedef struct __attribute__((packed)) SSwMacro
{
...
typedef struct __attribute__((packed)) SSwRemote
{
...
typedef struct __attribute__((packed)) SStatus2    //After edit
{
...
// typedef struct __attribute__((packed)) SStatus2  //Before edit
// {
//   uint8_t unused : 4;
//   uint8_t NodeSupports15BitPortAddress : 1;
//   uint8_t NodeIsDHCPCapable : 1;
...
typedef struct __attribute__((packed)) SArtPollReply
{
  uint8_t     ID[8];
  uint16_t    OpCode;
  uint8_t     IpAddress[4];
...
typedef struct __attribute__((packed)) SArtDmx
{
  uint8_t     ID[8];
  uint16_t    OpCode;
  uint8_t     ProtVerHi;
...
typedef struct __attribute__((packed)) SIpProg
{
  uint8_t     ID[8];
  uint16_t    OpCode;
  uint8_t     ProtVerHi;
...
typedef struct __attribute__((packed)) SIpProgReply
{
  //Comon
  uint8_t     ID[8];
  uint16_t    OpCode;
...
// static char         transmitBuffer[300];
// static uint8_t*     m_transmitbuf;
// static uint8_t*     m_ip;
// static uint8_t*     m_mac;
// static uint16_t     m_portaddress; 
